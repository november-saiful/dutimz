/**
 * Phase 4 Social Sharing — inline share buttons for Facebook, X, WhatsApp,
 * and a "copy link" button. Fully bilingual, glass-themed.
 */
"use client";
...
export function ShareButtons({
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-xs font-medium opacity-50 mr-1">{t.share}:</span>
      ...
      <button
        type="button"
        onClick={handleCopy}
        className="flex h-9 items-center gap-1.5 rounded-full px-3 text-xs font-medium transition-all hover:scale-105"
        style={{ background: "var(--md-sys-color-primary-container)" }}
